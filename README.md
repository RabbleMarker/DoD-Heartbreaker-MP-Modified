...
* Adjusted the Muscovy-PLC balance of power: Removed Bohemias sphere on PLC
...
* Fixed Beornias HBE and ENG formable (did not tag switch over properly, typo), Buffed HBE with Lotharingian accepted
* Gave Lotharingia army professionalism to help with their numbers disadvantage
* Nerfed Xifangs accepted pops in Indonesia (converted them to indonesian), buffed Xifangs Qingqiu path with a Lusitanian baby boom and south american migration
...
* Nerfed RP from conquest for the main Chinese nations (Taiping, Qing) to -0.1, nerfed Chinese RP gain by 40% (removed when forming China or westernizing). Forming China now gives 20K RP as compensation
